...
class CreditRiskMonitor:
    ...
    def get_metrics_summary(self) -> Dict:
        ...
        system_info = {
            ...
            'logs_path': str(self.log_dir)
        }
        
        if not self.metrics['predictions']:
            return {
                **system_info,
                'message': 'No hay datos de predicciones aún. Realiza algunas predicciones para ver métricas.',
                'prediction_count': 0
            }
        ...
        return {
            **system_info,  # Incluir información básica del sistema
